...
public class CommandListener implements Listener {
	...
	public CommandListener(Server server, WorldGuardPlugin worldGuard, WorldEditPlugin worldEdit, HgConfig hgConfig, Permission perms, Economy econ) {
		super();
		this.server = server;
