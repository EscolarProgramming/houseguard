...
import com.hg.listener.CommandListener;
...
public class HouseGuard extends JavaPlugin implements Listener {
	...
	public void onEnable() {
		...
		getServer().getPluginManager().registerEvents(new CommandListener(getServer(), getWorldGuard(), getWorldEdit(), hgConfig, perms, econ), this);
